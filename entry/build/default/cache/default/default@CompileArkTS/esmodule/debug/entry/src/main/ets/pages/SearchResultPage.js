...
export default class SearchResultPage extends ViewPU {
    ...
    TabBuilder(title, index, selectedImg, normalImg, parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Row.height({ "id": 16777335, "type": 10002, params: [], "bundleName": "org.malred.TravelApplication", "moduleName": "entry" });
            Row.width(80);
            Row.onClick(() => {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.margin({ top: 4 });
            Text.fontSize(16);
            Text.fontColor(this.current_index === index ? { "id": 16777297, "type": 10001, params: [], "bundleName": "org.malred.TravelApplication", "moduleName": "entry" } : { "id": 16777286, "type": 10001, params: [], "bundleName": "org.malred.TravelApplication", "moduleName": "entry" });
            if (!isInitialRender) {
                Text.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
    ...
    initialRender() {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            TabContent.tabBar({ builder: () => {
                    this.TabBuilder.call(this, '景点', 0, { "id": 16777425, "type": 20000, params: [], "bundleName": "org.malred.TravelApplication", "moduleName": "entry" }, { "id": 16777424, "type": 20000, params: [], "bundleName": "org.malred.TravelApplication", "moduleName": "entry" });
                } });
            if (!isInitialRender) {
                TabContent.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            TabContent.backgroundColor({ "id": 16777291, "type": 10001, params: [], "bundleName": "org.malred.TravelApplication", "moduleName": "entry" });
            TabContent.tabBar({ builder: () => {
                    this.TabBuilder.call(this, '酒店', 1, { "id": 16777425, "type": 20000, params: [], "bundleName": "org.malred.TravelApplication", "moduleName": "entry" }, { "id": 16777424, "type": 20000, params: [], "bundleName": "org.malred.TravelApplication", "moduleName": "entry" });
                } });
            if (!isInitialRender) {
                TabContent.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            TabContent.backgroundColor({ "id": 16777291, "type": 10001, params: [], "bundleName": "org.malred.TravelApplication", "moduleName": "entry" });
            TabContent.tabBar({ builder: () => {
                    this.TabBuilder.call(this, '旅游', 2, { "id": 16777425, "type": 20000, params: [], "bundleName": "org.malred.TravelApplication", "moduleName": "entry" }, { "id": 16777424, "type": 20000, params: [], "bundleName": "org.malred.TravelApplication", "moduleName": "entry" });
                } });
            if (!isInitialRender) {
                TabContent.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            TabContent.backgroundColor({ "id": 16777291, "type": 10001, params: [], "bundleName": "org.malred.TravelApplication", "moduleName": "entry" });
            TabContent.tabBar({ builder: () => {
                    this.TabBuilder.call(this, '攻略', 3, { "id": 16777425, "type": 20000, params: [], "bundleName": "org.malred.TravelApplication", "moduleName": "entry" }, { "id": 16777424, "type": 20000, params: [], "bundleName": "org.malred.TravelApplication", "moduleName": "entry" });
                } });
            if (!isInitialRender) {
                TabContent.pop();
            }
