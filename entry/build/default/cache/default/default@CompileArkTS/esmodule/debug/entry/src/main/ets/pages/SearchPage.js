...
export default class SearchPage extends ViewPU {
    ...
    initialRender() {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Image.create({ "id": 16777457, "type": 20000, params: [], "bundleName": "org.malred.TravelApplication", "moduleName": "entry" });
            Image.width(16);
            Image.height(16);
            Image.onClick((e) => {
                this.list_data = SearchViewModel.getRecommondItemData();
                ...
                const item = _item;
                {
                    ...
                    const observedDeepRender = () => {
                        ...
                        this.observeComponentCreation((elmtId, isInitialRender) => {
                            ...
                            Text.backgroundColor({ "id": 16777291, "type": 10001, params: [], "bundleName": "org.malred.TravelApplication", "moduleName": "entry" });
                            if (!isInitialRender) {
                                Text.pop();
                            }
                            ViewStackProcessor.StopGetAccessRecording();
