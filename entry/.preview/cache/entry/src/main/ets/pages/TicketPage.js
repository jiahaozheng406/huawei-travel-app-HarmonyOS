...
export default class TicketPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.debugLine("pages/TicketPage.ets(26:5)");
            Column.width('100%');
            Column.height('100%');
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("pages/TicketPage.ets(27:7)");
            if (!isInitialRender) {
                Row.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Swiper.debugLine("pages/TicketPage.ets(29:9)");
            // 轮播
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = _item => {
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                    Image.create(img);
                    Image.debugLine("pages/TicketPage.ets(31:13)");
                    Image.height(160);
                    Image.width('100%');
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Tabs.debugLine("pages/TicketPage.ets(41:7)");
            Tabs.vertical(false);
            if (!isInitialRender) {
                Tabs.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            TabContent.debugLine("pages/TicketPage.ets(47:9)");
            if (!isInitialRender) {
                // 导航内容
                TabContent.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            TabContent.debugLine("pages/TicketPage.ets(57:9)");
            if (!isInitialRender) {
                TabContent.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            TabContent.debugLine("pages/TicketPage.ets(63:9)");
            if (!isInitialRender) {
                TabContent.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            TabContent.debugLine("pages/TicketPage.ets(69:9)");
            if (!isInitialRender) {
                TabContent.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
