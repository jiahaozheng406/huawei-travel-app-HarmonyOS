export default class BuyCard extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.debugLine("view/ticket/BuyCard.ets(18:5)");
            // 卡片占一行
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 输入位置
            Row.create();
            Row.debugLine("view/ticket/BuyCard.ets(20:7)");
            // 输入位置
            Row.width('90%');
            if (!isInitialRender) {
                // 输入位置
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("view/ticket/BuyCard.ets(21:9)");
            TextInput.width('100%');
            TextInput.height(50);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 时间选择器
            Row.create({ space: 24 });
            Row.debugLine("view/ticket/BuyCard.ets(35:7)");
            // 时间选择器
            Row.width('90%');
            // 时间选择器
            Row.padding({ left: 8 });
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("view/ticket/BuyCard.ets(36:9)");
            Text.onClick(() => {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("view/ticket/BuyCard.ets(86:9)");
            Text.onClick(() => {
                DatePickerDialog.show({
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Button.debugLine("view/ticket/BuyCard.ets(139:7)");
            // 按钮
            Button.shadow({
                radius: 3,
                // color: $r('app.color.bg_shadow_color'),
