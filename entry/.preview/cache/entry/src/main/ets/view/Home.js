...
export default class Home extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Scroll.debugLine("view/Home.ets(64:5)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.debugLine("view/Home.ets(66:7)");
            // Column({ space: CommonConstants.COMMON_SPACE }) {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create({ space: 16 });
            Row.debugLine("view/Home.ets(67:9)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("view/Home.ets(69:11)");
            // 搜索框
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Button.debugLine("view/Home.ets(83:11)");
            Button.height(32);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 酒店|机票|火车票|旅游
            Grid.create();
            Grid.debugLine("view/Home.ets(108:9)");
            // .borderRadius({ bottomLeft: 12, bottomRight: 12 })
            // 酒店|机票|火车票|旅游
            Grid.backdropBlur(6);
            // .borderRadius({ bottomLeft: 12, bottomRight: 12 })
            ...
            Grid.shadow({
                radius: 2,
                // color: Color.Grey,
                color: { "id": 16777408, "type": 10001, params: [], "bundleName": "org.malred.TravelApplication", "moduleName": "entry" },
                // y偏移 -> 下
                offsetY: 3
            });
            // .borderRadius({ bottomLeft: 12, bottomRight: 12 })
            ...
            const forEachItemGenFunction = (_item, index) => {
                const item = _item;
                {
                    ...
                    const itemCreation = (elmtId, isInitialRender) => {
                        ...
                        GridItem.debugLine("view/Home.ets(110:13)");
                        if (!isInitialRender) {
                            GridItem.pop();
                        }
                        ViewStackProcessor.StopGetAccessRecording();
                    ...
                    const observedDeepRender = () => {
                        ...
                        this.observeComponentCreation((elmtId, isInitialRender) => {
                            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                            Column.create();
                            Column.debugLine("view/Home.ets(111:15)");
                            Column.onClick((e) => {
                                router.pushUrl({
                        ...
                        this.observeComponentCreation((elmtId, isInitialRender) => {
                            ...
                            Image.debugLine("view/Home.ets(112:17)");
                            Image.width(36);
                            Image.height(36);
                            if (!isInitialRender) {
                                Image.pop();
                        ...
                        this.observeComponentCreation((elmtId, isInitialRender) => {
                            ...
                            Text.debugLine("view/Home.ets(117:17)");
                            Text.fontSize(16);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Swiper.debugLine("view/Home.ets(166:9)");
            // 轮播
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = _item => {
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                    Image.create(img);
                    Image.debugLine("view/Home.ets(168:13)");
                    Image.borderRadius({ "id": 16777345, "type": 10002, params: [], "bundleName": "org.malred.TravelApplication", "moduleName": "entry" });
                    Image.height(100);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 榜单|攻略|特价
            Grid.create();
            Grid.debugLine("view/Home.ets(187:9)");
            // Text($r('app.string.home_list'))
            //   .fontSize($r('app.float.normal_text_size'))
            //   .fontWeight(FontWeight.Medium)
            //   .width(CommonConstants.FULL_PARENT)
            ...
            //   .margin({ top: $r('app.float.home_text_margin') })
            // 榜单|攻略|特价
            Grid.columnsGap({ "id": 16777332, "type": 10002, params: [], "bundleName": "org.malred.TravelApplication", "moduleName": "entry" });
            // Text($r('app.string.home_list'))
            //   .fontSize($r('app.float.normal_text_size'))
            //   .fontWeight(FontWeight.Medium)
            //   .width(CommonConstants.FULL_PARENT)
            //   .margin({ top: $r('app.float.home_text_margin') })
            // 榜单|攻略|特价
            Grid.rowsGap({ "id": 16777336, "type": 10002, params: [], "bundleName": "org.malred.TravelApplication", "moduleName": "entry" });
            if (!isInitialRender) {
                // Text($r('app.string.home_list'))
                //   .fontSize($r('app.float.normal_text_size'))
                //   .fontWeight(FontWeight.Medium)
            ...
            const forEachItemGenFunction = _item => {
                const secondItem = _item;
                {
                    ...
                    const itemCreation = (elmtId, isInitialRender) => {
                        ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                        GridItem.create(deepRenderFunction, isLazyCreate);
                        GridItem.padding({ top: { "id": 16777342, "type": 10002, params: [], "bundleName": "org.malred.TravelApplication", "moduleName": "entry" }, left: { "id": 16777342, "type": 10002, params: [], "bundleName": "org.malred.TravelApplication", "moduleName": "entry" } });
                        GridItem.borderRadius({ "id": 16777330, "type": 10002, params: [], "bundleName": "org.malred.TravelApplication", "moduleName": "entry" });
                        ...
                        GridItem.debugLine("view/Home.ets(189:13)");
                        if (!isInitialRender) {
                            GridItem.pop();
                        }
                        ViewStackProcessor.StopGetAccessRecording();
                    ...
                    const observedDeepRender = () => {
                        ...
                        this.observeComponentCreation((elmtId, isInitialRender) => {
                            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                            Column.create();
                            Column.debugLine("view/Home.ets(190:15)");
                        ...
                        this.observeComponentCreation((elmtId, isInitialRender) => {
                            ...
                            Text.debugLine("view/Home.ets(191:17)");
                        ...
                        this.observeComponentCreation((elmtId, isInitialRender) => {
                            ...
                            Text.debugLine("view/Home.ets(195:17)");
                            Text.margin({ top: { "id": 16777341, "type": 10002, params: [], "bundleName": "org.malred.TravelApplication", "moduleName": "entry" } });
                            Text.fontSize({ "id": 16777350, "type": 10002, params: [], "bundleName": "org.malred.TravelApplication", "moduleName": "entry" });
                            Text.fontColor({ "id": 16777409, "type": 10001, params: [], "bundleName": "org.malred.TravelApplication", "moduleName": "entry" });
                            Text.backdropBlur(3);
                            Text.fontColor(Color.White);
                            if (!isInitialRender) {
                                Text.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            WaterFlow.debugLine("view/Home.ets(226:9)");
            // .margin({ bottom: $r('app.float.setting_button_bottom') })
            // 瀑布流
            // WaterFlow({ footer: this.itemFoot.bind(this), scroller: this.scroller }) {
        ...
        });
        {
            const __lazyForEachItemGenFunction = (_item, index) => {
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                    FlowItem.create();
                    FlowItem.debugLine("view/Home.ets(228:13)");
                    FlowItem.shadow({
                        radius: 2,
                        // color: Color.Grey,
                        color: { "id": 16777408, "type": 10001, params: [], "bundleName": "org.malred.TravelApplication", "moduleName": "entry" },
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                    Column.create();
                    Column.debugLine("view/Home.ets(229:15)");
                    Column.clip(true);
                    if (!isInitialRender) {
                        Column.pop();
                    }
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ...
                    Image.debugLine("view/Home.ets(232:17)");
                    // Image('res/waterFlowTest(' + item % 5 + ').jpg')
                    //   .objectFit(ImageFit.Fill)
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                    Row.create({ space: 20 });
                    Row.debugLine("view/Home.ets(239:17)");
                    Row.width('100%');
                    Row.clip(true);
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                    // 用户头像
                    Image.create({ "id": 16777307, "type": 20000, params: [], "bundleName": "org.malred.TravelApplication", "moduleName": "entry" });
                    Image.debugLine("view/Home.ets(241:19)");
                    // 用户头像
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ...
                    // 标题
                    Text.create("N" + item);
                    Text.debugLine("view/Home.ets(247:19)");
                    // 标题
                    Text.fontSize(15);
                    if (!isInitialRender) {
                        // 标题
